...
function timeline_block_render_block_core_latest_posts($attributes) {
    ...
    if ($attributes['layoutcount']) {
        switch ($template) {
            case '1' :
                $list_items_markup = timeline_blocks_layout1($attributes);
                break;
            case '2' :
                $list_items_markup = timeline_blocks_layout2($attributes);
                break;
        }
    }
...
function timeline_block_get_tags_get_author( $post_id, $post ) {
	$list_items_markup = sprintf( '<a href="%2$s">%1$s</a></span></span>', esc_html( get_the_author_meta( 'display_name', $post->post_author ) ), esc_url( get_author_posts_url( $post->post_author ) ) );
...
function timeline_block_get_social_share_icons( $post_id ) {
	$social_share_info  = sprintf( '<a data-share="facebook" href="https://www.facebook.com/sharer.php?u=%1$s" class="tb-facebook-share social-share-default tb-social-share" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $post_id ) ) );
	$social_share_info .= sprintf( '<a data-share="twitter" href="https://twitter.com/share?url=%1$s" class="tb-twitter-share social-share-default tb-social-share" target="_blank"><i class="fab fa-twitter" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $post_id ) ) );
	$social_share_info .= sprintf( '<a data-share="linkedin" href="https://www.linkedin.com/shareArticle?url=%1$s" class="tb-linkedin-share social-share-default tb-social-share" target="_blank"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $post_id ) ) );
...
function timeline_blocks_layout1($attributes) {
    $post_thumb_id = '';
    $list_items_markup= '';
    ...
    if ($post_query->have_posts()) {
        ...
        while ($post_query->have_posts()) {
            ...
            if (isset($attributes['titleTag']) && in_array($attributes['titleTag'], $allowed_tags, true)) {
...
function timeline_blocks_layout2($attributes) {
    $post_thumb_id = '';
    $list_items_markup= '';
...
function timeline_block_get_social_share_info( $object, $field_name, $request ) {
	$object['ID']      = '';
	$social_share_info = sprintf( '<a data-share="facebook" href="https://www.facebook.com/sharer.php?u=%1$s" class="tb-facebook-share social-share-default tb-social-share" target="_blank"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $object['ID'] ) ) );
	$social_share_info .= sprintf( '<a data-share="twitter" href="https://twitter.com/share?url=%1$s" class="tb-twiiter-share social-share-default tb-social-share" target="_blank"><i class="fab fa-twitter" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $object['ID'] ) ) );
	$social_share_info .= sprintf( '<a data-share="linkedin" href="https://www.linkedin.com/shareArticle?url=%1$s" class="tb-linkedin-share social-share-default tb-social-share" target="_blank"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a>', esc_url( get_the_permalink( $object['ID'] ) ) );
	return $social_share_info;
}
