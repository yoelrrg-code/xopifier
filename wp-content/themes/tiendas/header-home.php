...
<html>
    ...
    <?php 
        $scrolled = !is_front_page() && @$post->post_name != 'nuestro-metodo' ? 'innerpage scrolled' : 'homepage'; 
    ?>
    
    <body <?php body_class('blur '.((is_front_page() || @$post->post_name == 'nuestro-metodo') ? 'homepage' : get_post_type()).' '.@$post->post_name.' page-'.@$post->post_name.' show-topbar')?>>
