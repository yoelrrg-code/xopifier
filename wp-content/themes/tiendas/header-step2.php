            ...
            <section id="header" class="topheader topheader-steps row <?php echo $scrolled?>">
                <div class="col-12 px-md-5 px-sm-2 px-2">
                    <div class="container px-0">
                        <div class="row">
                            <div class="col-12">
                                <div class="mainbar position-relative mainbar-steps d-flex align-items-center justify-content-end p-0">
                                    <div class="row m-0">
                                        <div class="flex-row d-flex col-12 align-items-center justify-content-between px-md-0 px-sm-4 px-4">
                                            <a class="logo-link logo-simple" href="<?php echo home_url(ICL_LANGUAGE_CODE.'/paso-2/');?>">
                                                <?php 
